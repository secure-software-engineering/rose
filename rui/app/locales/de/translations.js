export default {
  ...
  studyCreator: {
    ...
    fingerprintDesc: 'Der ausgewählte Speicher für Datensammel-Pakete enthält einen Signierschlüssel, um die Herkunft und Vertrauenswürdigkeit der Aufzeichnungsmuster nachzuweisen. ROSE prüft die Herkunft aller von diesem Speicher ausgelieferten Muster, bevor es diese lädt. Wenn Aktualisierungen auf \"sichere Aktualisierungen\" beschränkt werden, dann wird ROSE nur Muster aktualisieren, welche mit einem Schlüsselpaar signiert wurden, welches den folgenden Fingerabdruck für den öffentlichen Schlüssel besitzt. Dieser Fingerabdruck wird unabänderlich in der Konfigurationsdatei gespeichert. Bevor Sie weitermachen, prüfen Sie, ob der Fingerabdruck korrekt ist, ansonsten werden spätere Aktualisierungen fehlschlagen.',
