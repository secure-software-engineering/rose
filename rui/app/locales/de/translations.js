export default {
  ...
  wizard: {
    ...
    configOptions: "Wählen Sie eine der beiden Optionen um ROSE für den ersten Einsatz zu konfiguroeren.",
    ...
    privacyAgree: "Ich habe die Hinweise zum Datenschutz und Einblendungen gelesen. Ich möchte fortfahren."
  },
  ...
  settings: {
    ...
    extraFeaturesLabel: "ROSE hat zusätzliche Funktionen für Forscher und ROSE-Entwickler. Diese Funktionen sind nicht sichtbar, wenn sie nicht hier eingeschaltet werden.",
    resetRose: "ROSE-Konfiguration zurücksetzen",
    resetRoseLabel: "Wenn Sie die Konfiguration von ROSE zurücksetzen, wir der initiale Begrüßungsbildschirm wieder erscheinen. Sie können dann die Standardkonfiguration auswählen, oder eine spezielle Konfigurationsdatei für Ihre Studie laden.",
    manualUpdate: "Datensammel-Paket aktualisieren",
    manualUpdateLabel: "Social-Media-Plattformen wechseln zeitweise die Gestaltung Ihrer Webseiten. ROSE benötigt gelegentlich Aktualisierungen der Datensammel-Pakete um mit diesen Änderungen umgehen zu können. Um eine Aktualisierung manuell auszulösen, klicken Sie bitte den 'Update'-Knopf.",
  ...
  studyCreator: {
    ...
    roseCommentsDesc: "Kreuzen Sie diese Option an, wenn die Funktion für In-Situ-Kommentare für Ihre Teilnehmer verfügbar sein soll. Zur Zeit arbeitet diese Funktion nur für Facebook.",
    roseCommentsRating: "Hinzufügen der In-Situ-Bewertungsoption",
    roseCommentsRatingDesc: "Ankreuzen, falls die Funktion für In-Situ-Kommentare auch nach Bewertungen von Inhalten fragen soll.",
    salt: "Kryptografischer Salt für die Inhalte-Identifikatoren",
    saltDesc: "ROSE zeichnet pseudonyme Identifikatoren für Inhalte auf, die Interaktionen zu Inhalten und Personen zuordnenbar machen, ohne diese offenzulegen. Diese Identifikatoren werden aus dem Webseiten-Inhalt und einem kryptografischen Salt hergeleitet. Als Salt können Sie eine x-beliebige Zeichenkette verwenden, z.B. \"ROSE123\". Wenn Sie Gruppen von Teilnehmern untersuchen wollen, dann sollte der Salt jedoch bei allen Teilnehmern gleich sein, da Sie sonst nachträglich Daten über Teilnehmer hinweg nicht korrelieren können.",
    hashLength: "Länge des Identifikators für Inhalte und Personen",
    hashLengthDesc: "Hier können Sie Länge der pseudonymen Identifikatoren für ROSE festlegen. Sie müssen dabei Privatsphäre der Teilnehmer und Eindeutigkeit des Identifikators abwägen. Kürzere Identifikatoren sind privatsphäreschützender; längere Identifikatoren sind einzigartiger. Jede zusätzliche Stelle erhöht den Raum verfügbarer Identifikatoren um den Faktor 16. Zum Beispiel, erlaubt die Länge 4 16*16*16*16=65536 eindeutige Identifikatoren für Ihre Studie. Als Daumenregel ist 5 ein in der Praxis bewährter Wert.",
    ...
    autoUpdateDesc: "Erkennungsmuster während normalerweise nur mit einer Konfigurationsdatei in ROSE geladen. Es ist aber auch möglich sie kontinuierlich zu aktualisieren während eine Studie läuft. Dies ist besonders wichtig für Langzeit-Studien, während der die Webseiten von Social-Media-Plattformen viele Änderungen erfahren können.",
    ...
    fingerprintDesc: "Aus Sicherheitsgründen müssen die Muster in den Datensammel-Paketen mit RSA signiert werden. Diese Signatur wird geprüft, bevor ROSE die enthaltenen Muster lädt. Bitte geben Sie den Fingerabdruck für den öffentlichen Schlüssel ein, welchen ROSE benutzen soll um die digitale Signatur zu prüfen.",
    ...
    updateInterval: "Intervall for die automatische Prüfung auf Aktualisierung der Datensammel-Pakete",
  ...
  dataConverter: {
    ...
    subtitle: "Konverter um XML-ROSE-Exporte in CSV-Dateien umzuwandeln. Laden Sie die XML_Datei und wählen Sie die Datensätze, welche in die CSV-Datei übertragen werden sollen."
  }
};
